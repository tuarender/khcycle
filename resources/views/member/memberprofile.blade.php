    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="panel panel-primary loginPanel">
                <div class="loginPanel loginPanelHeader panel-heading ">Profile</div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="logout">
                        ...
                        <div class="form-group @if ($errors->has('member_name')) has-error @endif">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="member_name" value="{{ $members['KH_CONTACT_NAME'] }}" readonly>
                        ...
                        <div class="form-group @if ($errors->has('member_tel')) has-error @endif">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="member_tel" value="{{ $members['KH_CONTACT_TEL']  }}" readonly>
                        ...
                        <div class="form-group @if ($errors->has('member_address')) has-error @endif">
                            ...
                            <div class="col-sm-5">
                                <textarea rows="5"  class="form-control" name="member_address" id="" readonly>{{ $members['KH_CONTACT_ADDR'] }}</textarea>
                        ...
                        <div class="form-group @if ($errors->has('member_shoe')) has-error @endif">
                            ...
                            <div class="col-sm-4">
                                <input type="text"  class="form-control" onkeypress="validate(event)" name="member_shoe" maxlength="4" value="{{ $members['KH_INFORMATION_SHOE']  }}" readonly>
                        ...
                        <div class="form-group @if ($errors->has('member_line')) has-error @endif">
                            ...
                            <div class="col-sm-4">
                                <input type="text"  class="form-control" onkeypress="validate(event)" name="member_line" maxlength="4" value="{{ $members['KH_INFORMATION_LINE']  }}" readonly>
                        ...
                        <div class="form-group @if ($errors->has('member_bike')) has-error @endif">
                            ...
                            <div class="col-sm-4">
                                <input type="text"  class="form-control" onkeypress="validate(event)" name="member_bike" maxlength="4" value="{{ $members['KH_INFORMATION_BIKE']  }}" readonly>

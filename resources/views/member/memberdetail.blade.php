                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="updatemember/{{$members['ID']}}">
                            ...
                            <div class="form-group @if ($errors->has('member_line')) has-error @endif">
                                ...
                                <div class="col-sm-4">
                                    <input type="text"  class="form-control" name="member_line" maxlength="4" value="{{ $members['KH_INFORMATION_LINE']  }}" >
                            ...
                            <div class="form-group @if ($errors->has('member_bike')) has-error @endif">
                                ...
                                <div class="col-sm-4">
                                    <input type="text"  class="form-control" onkeypress="validate(event)" name="member_bike" maxlength="4" value="{{ $members['KH_INFORMATION_BIKE']  }}" >
